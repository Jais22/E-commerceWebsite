  ...
  return (
    <>
        <div>
            ...
            <h2 className='absolute top-[60%] left-[10%] text-white font-semibold text-3xl md:text-5xl '>Sign Up</h2>
            </div>
{/*signupForm*/}
    ...
    <div className="mx-auto bg-red-500 rounded-lg p-8 flex flex-col mt-8 md:mt-0 shadow-md text-white w-[500px]">
      <h2 className="text-white text-4xl mb-1 font-medium title-font">Sign Up</h2>
